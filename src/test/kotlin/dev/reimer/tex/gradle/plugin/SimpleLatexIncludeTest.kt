...
object SimpleLatexIncludeTest : Test {

    override val directory = getResourceFile("simple-latex-include")
    ...
    override val description = "Simple LaTeX project with include should build."
